...
const ENRICHMENT: Record<Category, string> = {
  gaming:
    "Free Fire style YouTube gaming thumbnail, Garena Free Fire battle royale aesthetic, stylized semi-realistic 3D character render in the exact look of Free Fire in-game characters (clean smooth skin shading, slightly exaggerated proportions, sharp jawline, glossy hair, vibrant outfit, hoodie or bomber jacket, urban streetwear mixed with tactical vest), confident hero pose holding an MP40-style submachine gun or AWM-style sniper rifle, finger on trigger, looking directly at camera, tropical Bermuda island background with palm trees and shipping containers, parachute and Free Fire-style supply crate in the sky, fire and orange explosion particles, gloo wall fragments, bold red and yellow accent color grade matching Free Fire branding, dramatic rim light, lens flare, dust and ember particles, large empty space on the left for big bold YouTube title text, ultra sharp 4K, hyper-detailed, click-bait thumbnail composition, professional esports key art, no blurry text, no extra fingers, no deformed face",
  tech:
